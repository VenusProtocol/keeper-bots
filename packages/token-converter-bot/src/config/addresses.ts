...
export const underlyingByComptroller: Record<Address, readonly Address[]> = {
  bsctestnet: {
    ...
    ["0x596B11acAACF03217287939f88d63b51d3771704" as Address]: [

...
export const getUnderlyingByComptroller = (): Record<Address, readonly Address[]> => {
  const { network } = getConfig();
  return {
    bsctestnet: {
      [bsctestnetCore.addresses.Unitroller as Address]: [
    ...
    bscmainnet: {
      [bscmainnetCore.addresses.Unitroller as Address]: [
      ...
      ["0x1b43ea8622e76627B81665B1eCeBB4867566B963" as Address]: [
        "0x55d398326f99059ff775485246999027b3197955",
      ...
      ["0x3344417c9360b963ca93A4e8305361AEde340Ab9" as Address]: [
        "0x55d398326f99059ff775485246999027b3197955",
        "0xd17479997f34dd9156deef8f95a52d81d265be9c",
...
export const getUnderlyingToVTokens = (): Record<
  Address,
  ...
  return {
    bsctestnet: {
      ...
      ["0x2999c176ebf66ecda3a646e70ceb5ff4d5fcfb8c" as const]: {
        ...
        isolated: [
          [
            "0x596B11acAACF03217287939f88d63b51d3771704" as const,
            "0x75aa42c832a8911B77219DbeBABBB40040d16987" as const,
          ],
        ] as [Address, Address][],
      },
      // usdd
